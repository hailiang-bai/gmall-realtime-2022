...
/**
 * 加购，事务性事实表，使用flinkSql的 lookUp表（从mysql中直接读取表）
 */
...
public class DwdTradeCartAdd {
    public static void main(String[] args) throws Exception {
        ...
        //TODO 2.使用DDL（Data Definition Language）方式读取topic_db主题中的数据创建表,事实表
...
//        tableEnv.toAppendStream(cartAddTable, Row.class).print(">>>>>>>>>>>");
        ...
        //TODO 7.将数据从关联表中写出到创建的事实表（创建时包含kafka分区）中
